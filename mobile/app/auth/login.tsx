      ...
      <TouchableWithoutFeedback onPress={dismissKeyboard} accessible={false}>
        <View className="flex-1 w-full h-full py-8 px-16 justify-center items-center">
          ...
          <View className="w-full items-center">
            <TouchableOpacity
              className="w-3/4 px-2 py-4 bg-secondaryColor items-center rounded-full"
              onPress={handleLogin}
            >
          ...
          <View className="w-full items-center mb-4">
            <TouchableOpacity
              className="w-3/4 px-2 py-4 items-center rounded-full bg-slate-200"
              onPress={() => handleOAuth("google", pathname)}
            >
          ...
          <View className="w-full items-center">
            <TouchableOpacity
              className="w-3/4 px-2 py-4 items-center rounded-full bg-facebookBlue"
